...
static struct PyMethodDef module_functions[] = {
    {"longest", longest, METH_O, longest_doc}, {NULL, NULL}};

static struct PyModuleDef moduledef = {
    PyModuleDef_HEAD_INIT,
    "trending_homebrew._trending_homebrew", /* m_name */
    NULL,                                   /* m_doc */
    -1,                                     /* m_size */
...
PyMODINIT_FUNC PyInit__trending_homebrew(void) { return moduleinit(); }
